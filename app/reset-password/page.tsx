            ...
            {success ? (
              ...
              <>
                ...
                <button
                  ...
                  style={{
                    width: '100%', padding: '16px', borderRadius: 100, border: 'none', fontFamily: HP_FONT, fontWeight: 800, fontSize: 15,
                    background: loading || !email || !token ? HP_TOKENS.lineSoft : `linear-gradient(135deg, ${HP_TOKENS.primary}, #FF8C00)`,
                    color: loading || !email || !token ? HP_TOKENS.inkMute : '#fff', cursor: loading || !email || !token ? 'not-allowed' : 'pointer',
                    boxShadow: loading || !email || !token ? 'none' : `0 8px 24px rgba(255,107,53,0.3)`, transition: 'all 0.2s',
