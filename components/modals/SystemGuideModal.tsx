          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 10 }}>
            {[
              ...
              <div key={item.label} style={{ 
                ...
                <div style={{ ...HP_TEXT.small, color: HP_TOKENS.sage, fontWeight: 700, fontSize: 13, marginTop: 'auto' }}>{item.pts} Poin</div>
              </div>
            ))}
          </div>
          <div style={{ ...HP_TEXT.tiny, color: HP_TOKENS.coral, marginTop: 16, textAlign: 'center', fontWeight: 700 }}>
        ...
        <section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            <div style={milestoneStyle}>
              ...
              <span style={{ fontWeight: 700 }}>100 Poin / Level</span>
            </div>
            <div style={milestoneStyle}>
              <span>Level 11 - 20</span>
              <span style={{ fontWeight: 700 }}>300 Poin / Level</span>
            </div>
            <div style={milestoneStyle}>
              <span>Level 21+</span>
              <span style={{ fontWeight: 700 }}>1,000 Poin / Level</span>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 8 }}>
            {[
              ...
              { rank: 'D', lv: 'Lv. 11-20', color: HP_TOKENS.success },
              { rank: 'C', lv: 'Lv. 21-35', color: HP_TOKENS.blue },
              { rank: 'B', lv: 'Lv. 36-50', color: HP_TOKENS.yellowDark },
              { rank: 'A', lv: 'Lv. 51-70', color: HP_TOKENS.danger },
              { rank: 'S', lv: 'Lv. 71+', color: HP_TOKENS.primary },
            ].map(r => (
