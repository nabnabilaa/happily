...
window.__FB.ROLE_MODULES = {
  employee: {
    tabs: [
      ...
      { key: 'okr',   icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>', label: 'OKR' },
    ...
    features: ['tasks', 'notes', 'timer', 'calendar', 'chat', 'kpi_link', 'okr', 'okr_individual'],
    accent: '#4A90E2',
  ...
  manager: {
    ...
    features: ['tasks', 'notes', 'timer', 'calendar', 'chat', 'team_overview', 'verify_tasks', 'kpi_link', 'okr', 'okr_individual', 'okr_team', 'okr_review', 'okr_assign'],
    accent: '#3B6FA0',
  ...
  hr: {
    ...
    features: ['tasks', 'notes', 'timer', 'calendar', 'chat', 'people_overview', 'company_metrics', 'kpi_link', 'okr', 'okr_individual', 'okr_company', 'okr_reports'],
    accent: '#7B6BB5',
